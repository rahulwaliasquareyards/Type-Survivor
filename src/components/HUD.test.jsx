...
describe('HUD', () => {
  it('displays the score', () => {
    render(<HUD voiceEnabled={false} onToggleVoice={() => {}} score={250} lives={3} muted={false} onToggleMute={() => {}} />)
    expect(screen.getByText(/250/)).toBeInTheDocument()
  })

  it('shows 3 life icons total', () => {
    const { container } = render(<HUD voiceEnabled={false} onToggleVoice={() => {}} score={0} lives={2} muted={false} onToggleMute={() => {}} />)
  ...
  it('calls onToggleMute when mute button clicked', () => {
    ...
    render(<HUD voiceEnabled={false} onToggleVoice={() => {}} score={0} lives={3} muted={false} onToggleMute={onToggleMute} />)
